    ...
    emailEvents.forEach((ee, idx) => {
      ...
      const exists = googleEvents.some(
        (ge) =>
          ...
          new Date(ge.start).toDateString() ===
            new Date(eeStart).toDateString(),
      );
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className='sm:max-w-2xl p-6'>
        <DialogHeader>
          ...
          <DialogDescription>
            View blocked slots and scheduled events fetched directly from your
            calendar.
          </DialogDescription>
        </DialogHeader>
        ...
        {loading ? (
          ...
          <div className='flex h-64 flex-col items-center justify-center text-center p-4'>
            ...
            <p className='text-sm text-muted-foreground mt-1'>
              Please connect your Google Calendar in settings to enable this
              feature.
            </p>
          ...
          <div className='grid gap-6 md:grid-cols-2 mt-2'>
            ...
            <div className='flex flex-col items-center border border-border p-2 rounded-xl bg-card'>
              <Calendar
                ...
                modifiersClassNames={{
                  blocked:
                    "bg-destructive/20 text-destructive font-semibold border border-destructive/40 hover:bg-destructive/30 hover:text-destructive",
                }}
              />
