...
export default function Home() {
  return (
    <div className='landing-wrapper min-h-screen flex flex-col bg-background text-foreground overflow-x-hidden pt-6'>
              ...
              <Show when='signed-in'>
                <Link href='/dashboard'>
                  <Button
                    variant='ghost'
                    size='sm'
                    className='hidden sm:inline-flex gap-1 h-9 px-3.5 text-xs font-bold uppercase'
                  >
              ...
              <Show when='signed-out'>
                <SignInButton mode='modal'>
                  <Button
                    variant='ghost'
                    size='sm'
                    className='text-xs font-bold uppercase h-9 px-3.5'
                  >
                    Sign In
                  </Button>
                </SignInButton>
                <SignUpButton mode='modal'>
                  <Button
                    size='sm'
                    className='text-xs font-bold uppercase h-9 px-3.5 shadow-sm'
                  >
                    Get Started
                  </Button>
                </SignUpButton>
      ...
      <section className='relative pt-24 pb-12 sm:pt-28 sm:pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full'>
        <div className='text-center max-w-4xl mx-auto flex flex-col items-center'>
          ...
          <p className='text-sm sm:text-base text-muted-foreground max-w-xl leading-relaxed mb-6'>
            ExecOS runs in the background to analyze your inbox, categorize key
            priority items, auto-draft replies, and dynamically block your
            Google Calendar.
          </p>
          ...
          <div className='flex flex-col sm:flex-row gap-3 justify-center w-full sm:w-auto mb-10'>
            <Show when='signed-in'>
              <Link href='/dashboard'>
                <Button
                  size='lg'
                  className='w-full sm:w-auto text-sm font-semibold uppercase tracking-wider gap-2 h-11 px-6 shadow-md shadow-primary/10'
                >
            ...
            <a href='#features'>
              <Button
                size='lg'
                variant='outline'
                className='w-full sm:w-auto text-sm font-semibold uppercase tracking-wider h-11 px-6'
              >
                See How It Works
              </Button>
            </a>
                ...
                <div className='flex items-start justify-between'>
                  <div className='space-y-1'>
                    <div className='flex items-center gap-2'>
                      ...
                      <div className='h-4.5 w-14 rounded-full bg-destructive/10 text-destructive text-[9px] flex items-center justify-center font-bold'>
                        Blocked
                      </div>
                    </div>
      ...
      <section className='py-8 border-y border-border/40 bg-muted/10 relative w-full'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <div className='flex justify-center items-center gap-12 opacity-50 max-w-4xl mx-auto flex-wrap'>
            <span className='text-sm font-black tracking-widest text-foreground font-mono'>
              STRIPE
            </span>
            <span className='text-sm font-black tracking-widest text-foreground font-mono'>
              VERCEL
      ...
      <section
        id='features'
        className='py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative w-full'
      >
        <div className='text-center max-w-2xl mx-auto mb-10'>
          ...
          <p className='text-muted-foreground text-sm'>
            Stop managing your assistant and let ExecOS handle email
            classification and scheduling background tasks seamlessly.
          </p>
        </div>
        ...
        <div className='grid gap-4 md:grid-cols-3'>
          {[
            ...
            <Card
              key={idx}
              className='p-5 border border-border/80 bg-card hover:border-foreground/20 hover:-translate-y-0.5 transition-all duration-300'
            >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <div className='max-w-2xl mx-auto mb-8'>
            ...
            <p className='text-muted-foreground text-xs'>
              Secure Google OAuth connectors provide quick read-write bindings
              for calendar and mail APIs.
            </p>
          </div>
      ...
      <section
        id='pricing'
        className='py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative w-full border-t border-border/40'
      >
        <div className='text-center max-w-2xl mx-auto mb-10'>
          <h2 className='text-2xl sm:text-3xl font-extrabold tracking-tight mb-3'>
          ...
          <p className='text-muted-foreground text-sm'>
            Choose the plan that suits your executive workflow. Toggle
            configurations inside your user account settings anytime.
          </p>
        </div>
      ...
      <section
        id='faq'
        className='py-14 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative w-full border-t border-border/40'
      >
        <div className='text-center mb-10'>
          ...
          <p className='text-muted-foreground text-sm font-medium'>
            Answers to common operational and privacy questions.
          </p>
        </div>
        {/* @ts-ignore */}
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
            <div className='space-y-3 md:col-span-2'>
              ...
              <p className='text-xs text-muted-foreground leading-relaxed max-w-xs'>
                ExecOS is an enterprise-grade AI operations platform built to
                automate scheduling, categorizing, and drafting workflows
                securely.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className='space-y-2 text-xs text-muted-foreground font-mono'>
                <li className='flex items-center gap-1.5'>
                  <Shield className='h-3.5 w-3.5 text-primary' /> WCAG AA
                </li>
                <li className='flex items-center gap-1.5'>
                  <Lock className='h-3.5 w-3.5 text-primary' /> OAuth 2.0
                </li>
              </ul>
            </div>
          </div>
