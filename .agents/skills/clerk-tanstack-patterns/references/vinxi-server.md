...
TanStack Start uses Vinxi as its build tool and server runtime. Register
`clerkMiddleware` in `src/start.ts`:
...
Add `ClerkProvider` to the root route shell component in
